...
## Farsi Dataset Generation
Use this command to generate persian pairs of images and labels

```bash
python trdg/run.py --language fa --count 500 --output_dir temp --skew_angle 20 --random_skew --blur 1 --random_blur
```
